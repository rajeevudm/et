                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <p align=”justify”>The Centre of Research on Emerging Technologies and Innovation has been created and launched in 2023. It is a truly interdisciplinary center of research working in three thematic areas namely :
                                        Remote Sensing, Intelligent Systems and Bioinformatics. The founder, Dr Rajeev Khoodeeram, is pleased to welcome you to CREETIV and discover our three research labs which includes researchers from academia and industry 
                                        as well as PhD students. Our primary vision is to find solutions to problems faced by Mauritius and the region.
                                        As such, our teams are thriving hard to solve environmental, societal and health-related problems.</p>
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="feturead mb-30 mb-sm-30">
                                        ...
                                        <div class="bg-white p-20">
                                            ...
                                            <a class="btn btn-theme-colored btn-sm btn-flat" href="./remote_sensing_lab.html">View Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="feturead mb-30 mb-sm-30">
                                        ...
                                        <div class="bg-white p-20">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetu radipisi cing elitBeatae autem aperiam nequ quaera molestias voluptatibus.</p>
                                            <a class="btn btn-theme-colored btn-sm btn-flat" href="intelligent_systems_lab.html">View Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="feturead mb-30 mb-sm-30">
                                        ...
                                        <div class="bg-white p-20">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetu radipisi cing elitBeatae autem aperiam nequ quaera molestias voluptatibus.</p>
                                            <a class="btn btn-theme-colored btn-sm btn-flat" href="bioinformatics_lab.html">View Details</a>
                                        </div>
                                    </div>
                                </div>
