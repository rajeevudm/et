...
<html dir="ltr" lang="en">
    <head>
        ...
        <meta name="description" content="Emerging Technologies" />
        ...
        <div id="side-panel" class="dark" data-bg-img="http://placehold.it/1920x1280">
            <div class="side-panel-wrap">
                ...
                <div class="side-panel-widget mt-30">
                    ...
                    <p>Copyright &copy;2022. Department of Emerging Technologies</p>
                </div>
            </div>
        </div>
                                ...
                                <ul>
                                    ...
                                    <li data-index="rs-3" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x743"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                                        ...
                                        <div class="tp-caption tp-resizeme text-uppercase text-black"
                                             ...
                                             style="z-index: 7; white-space: nowrap; font-weight:bolder; font-weight:700;">An interdisciplinary
                                        </div>
                                        ...
                                        <div class="tp-caption tp-resizeme text-uppercase text-theme-colored font-raleway"
                                             ...
                                             data-splitout="none" 
                                             data-responsive_offset="on"
                                             style="z-index: 7; white-space: nowrap; font-weight:800;">Center of Research
                                        </div>
                                    ...
                                    <li data-index="rs-2" data-transition="random" data-slotamount="7"  data-easein="default" data-easeout="default" data-masterspeed="1000"  data-thumb="http://placehold.it/1920x743"  data-rotate="0"  data-fstransition="fade" data-fsmasterspeed="1500" data-fsslotamount="7" data-saveperformance="off"  data-title="Intro" data-description="">
                                        ...
                                        <div class="tp-caption tp-resizeme text-uppercase text-theme-colored"
                                             ...
                                             data-splitout="none" 
                                             data-responsive_offset="on"
                                             style="z-index: 7; white-space: nowrap; font-weight:800;">Trainings, Workshops and more 
                                        </div>
                        ...
                        <div class="section-content">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <h2 class="text-uppercase font-weight-600 mt-0 font-28 line-bottom">Centre of Research on Emerging Technologies and Innovation (CREETIV)</h2>
                                    <h4 class="text-theme-colored">Welcome to CREETIV</h4>
                                    <p align=”justify”>The Centre of Research on Emerging Technologies and Innovation has been created and launched in 2023. It is a truly interdisciplinary center of research working in three thematic areas namely :
                                        Remote Sensing, Intelligent Systems and Bioinformatics. The founder, Dr Rajeev Khoodeeram, is pleased to welcome you to <b>CREETIV</b> and discover our three research labs which includes researchers from academia and industry 
                                        as well as our proud PhD students. Our primary vision is to find solutions to problems faced by Mauritius and the region.
                                        As such, our teams are collaborating with national, regional and international researchers hard to solve environmental, societal and health-related problems.</p>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                                <div class="funfact text-center">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="17" class="animate-number text-white font-42 font-weight-500">0</h2>
                                    <h5 class="text-white text-uppercase font-weight-600">Researchers</h5>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                                <div class="funfact text-center">
                                    <i class="pe-7s-rocket mt-5 text-white"></i>
                                    <h2 data-animation-duration="2000" data-value="10" class="animate-number text-white font-42 font-weight-500">0</h2>
                                    <h5 class="text-white text-uppercase font-weight-600">Papers</h5>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                                <div class="funfact text-center">
                                    <i class="pe-7s-add-user mt-5 text-white"></i>
                                    <h2 data-animation-duration="2000" data-value="4" class="animate-number text-white font-42 font-weight-500">0</h2>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-3 mb-md-50">
                                <div class="funfact text-center">
                                    ...
                                    <h2 data-animation-duration="2000" data-value="2" class="animate-number text-white font-42 font-weight-500">0</h2>
                                    <h5 class="text-white text-uppercase font-weight-600">Consultancy</h5>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section id="departments" class="bg-lighter">
                    <div class="container">
                        <div class="section-title text-center">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <h2 class="text-uppercase mt-0 line-height-1">Our Labs</h2>
                                    <div class="title-icon">
                                        <img class="mb-10" src="images/title-icon.png" alt="">
                                    </div>
                                    <p>Find below the different labs and the wonderful works being done</p>
                                </div>
                            </div>
                        </div>
                        <div class="section-content">
                                ...
                                <div class="col-md-4 col-sm-6">
                                    <div class="feturead mb-30 mb-sm-30">
                                        ...
                                        <div class="bg-white p-20">
                                            <h4 class="line-bottom text-uppercase font-weight-600 mt-0 mb-15">Remote Sensing and Data</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetu radipisi cing elitBeatae autem aperiam nequ quaera molestias voluptatibus.</p>
                                            <a class="btn btn-theme-colored btn-sm btn-flat" href="./remote_sensing_lab.php">View Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="feturead mb-30 mb-sm-30">
                                        <div class="thumb"> <img src="http://placehold.it/360x205" class="img-fullwidth" alt=""> </div>
                                        <div class="bg-white p-20">
                                            <h4 class="line-bottom text-uppercase font-weight-600 mt-0 mb-15">Intelligent Systems</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetu radipisi cing elitBeatae autem aperiam nequ quaera molestias voluptatibus.</p>
                                            <a class="btn btn-theme-colored btn-sm btn-flat" href="intelligent_systems_lab.php">View Details</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6">
                                    <div class="feturead mb-30 mb-sm-30">
                                        <div class="thumb"> <img src="http://placehold.it/360x205" class="img-fullwidth" alt=""> </div>
                                        <div class="bg-white p-20">
                                            <h4 class="line-bottom text-uppercase font-weight-600 mt-0 mb-15">Bioinformatics</h4>
                                            <p>Lorem ipsum dolor sit amet, consectetu radipisi cing elitBeatae autem aperiam nequ quaera molestias voluptatibus.</p>
                                            <a class="btn btn-theme-colored btn-sm btn-flat" href="bioinformatics_lab.php">View Details</a>
                                        </div>
                                    </div>
                                </div>
                ...
                <section id="doctors">
                    <div class="container">
                        <div class="section-title text-center">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <h2 class="text-uppercase mt-0 line-height-1">Our Researchers</h2>
                                    <div class="title-icon">
                                        <img class="mb-10" src="images/title-icon.png" alt="">
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem<br> voluptatem obcaecati!</p>
                                ...
                                <div class="owl-carousel-4col">
                                    <div class="item">
                                        <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                                            ...
                                            <div class="team-details bg-silver-light pt-10 pb-10">
                                                <h4 class="text-uppercase font-weight-600 m-5">Dr. Rajeev Khoodeeram</h4>
                                    ...
                                    <div class="item">
                                        <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                                            ...
                                            <div class="team-details bg-silver-light pt-10 pb-10">
                                                <h4 class="text-uppercase font-weight-600 m-5">Dr. Jay Doorga</h4>
                                                <h6 class="text-theme-colored font-15 font-weight-400 mt-0">Mbbs Doctor</h6>                    
                                                <ul class="styled-icons icon-theme-colored icon-dark icon-circled icon-sm">
                                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                                    ...
                                    <div class="item">
                                        <div class="team-members border-bottom-theme-color-2px text-center maxwidth400">
                                            ...
                                            <div class="team-details bg-silver-light pt-10 pb-10">
                                                <h4 class="text-uppercase font-weight-600 m-5">Dr. Keshav Sewraj</h4>
                                                <h6 class="text-theme-colored font-15 font-weight-400 mt-0">Mbbs Doctor</h6>                    
                                                <ul class="styled-icons icon-theme-colored icon-dark icon-circled icon-sm">
                                                    <li><a href="#"><i class="fa fa-facebook"></i></a></li>
                                                    <li><a href="#"><i class="fa fa-twitter"></i></a></li>
                ...
                <section id="pricing" class="bg-silver-light">
                    <div class="container pb-30">
                        <div class="section-title text-center">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    <h2 class="text-uppercase mt-0 line-height-1">Our PhD Students</h2>
                                    <div class="title-icon">
                                        <img class="mb-10" src="images/title-icon.png" alt="">
                                    </div>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem<br> voluptatem obcaecati!</p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="portfolio-filter font-alt text-center">
                                    ...
                                    <a href="#dental" class="" data-filter=".dental">Remote Sensing & Data</a>
                                    <a href="#surgery" class="" data-filter=".surgery">Intelligent Systems</a>
                                    <a href="#laboratory" class="" data-filter=".laboratory">Bioinformatics</a>
                                </div>
                                <!-- End Works Filter -->
                        ...
                        <div class="section-title text-center">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <p>Below are some upcoming events organised by the different labs</p>
                                </div>
                            </div>
                        </div>
                        <div class="section-content">
                                            ...
                                            <article class="post clearfix bg-white">
                                                ...
                                                <div class="entry-content p-15 pt-10 pb-10">
                                                    <div class="entry-meta media no-bg no-border mt-0 mb-10">
                                                        <div class="media-body pl-0">
                                                            <div class="event-content pull-left flip">
                                                                <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="blog-single-left-sidebar.html">Training on Python</a></h4>
                                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i>Bioinformatics</span>
                                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>
                                                            </div>
                                                        </div>
                                            ...
                                            <article class="post clearfix bg-white">
                                                ...
                                                <div class="entry-content p-15 pt-10 pb-10">
                                                    <div class="entry-meta media no-bg no-border mt-0 mb-10">
                                                        <div class="media-body pl-0">
                                                            <div class="event-content pull-left flip">
                                                                <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="#">Training on AI</a></h4>
                                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-commenting-o mr-5 text-theme-colored"></i>Intelligent Systems</span>
                                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-heart-o mr-5 text-theme-colored"></i> 895 Likes</span>                      
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <article class="post clearfix bg-white">
                                                ...
                                                <div class="entry-content p-15 pt-10 pb-10">
                                                    <div class="entry-meta media no-bg no-border mt-0 mb-10">
                                                        <div class="media-body pl-0">
                                                            <div class="event-content pull-left flip">
                                                                <h4 class="entry-title text-white text-uppercase font-weight-600 m-0 mt-5"><a href="blog-single-left-sidebar.html">Training on Remote Sensing</a></h4>
                                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-terminal mr-5 text-theme-colored"></i>Remote sensing & Data</span>
                                                                <span class="mb-10 text-gray-darkgray mr-10 font-13"><i class="fa fa-male mr-5 text-theme-colored"></i>Dr Jay Doorga</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <p class="mt-5">Lorem ipsum dolor sit amet, consectetur adipisi cing elit. Molestias eius illum libero dolor nobis deleniti<a class="text-theme-color-2 font-12 ml-5" href="blog-single-left-sidebar.html"> View Details</a></p>
